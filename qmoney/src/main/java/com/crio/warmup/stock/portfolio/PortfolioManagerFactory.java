...
public class PortfolioManagerFactory {
  ...
  public static PortfolioManager getPortfolioManager(RestTemplate restTemplate,StockQuotesService stockQuoteService) {

     return new PortfolioManagerImpl(restTemplate,stockQuoteService);
  }
